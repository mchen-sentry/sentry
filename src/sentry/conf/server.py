...
# Option values migrated from environment-backed configuration to Django settings.
# DEAD during the bridge; bootstrap_options promotes legacy SENTRY_OPTIONS values
# into these via options_mapper so existing config.yml deployments keep working.
SENTRY_CODECOV_SIGNING_SECRET = DEAD
SENTRY_SMS_TWILIO_TOKEN = DEAD
SENTRY_SLACK_CLIENT_SECRET = DEAD
SENTRY_SLACK_VERIFICATION_TOKEN = DEAD
SENTRY_SLACK_SIGNING_SECRET = DEAD
SENTRY_SLACK_STAGING_CLIENT_SECRET = DEAD
SENTRY_SLACK_STAGING_SIGNING_SECRET = DEAD
SENTRY_GITHUB_APP_CLIENT_SECRET = DEAD
SENTRY_GITHUB_APP_WEBHOOK_SECRET = DEAD
SENTRY_GITHUB_APP_PRIVATE_KEY = DEAD
SENTRY_GITHUB_CONSOLE_SDK_APP_INSTALLATION_ID = DEAD
SENTRY_GITHUB_CONSOLE_SDK_APP_PRIVATE_KEY = DEAD
SENTRY_GITHUB_CONSOLE_SDK_APP_CLIENT_SECRET = DEAD
SENTRY_VSTS_CLIENT_SECRET = DEAD
SENTRY_VSTS_NEW_CLIENT_SECRET = DEAD
SENTRY_VSTS_LIMITED_CLIENT_SECRET = DEAD
SENTRY_VERCEL_CLIENT_SECRET = DEAD
SENTRY_MSTEAMS_CLIENT_SECRET = DEAD
SENTRY_DISCORD_BOT_TOKEN = DEAD
SENTRY_DISCORD_CLIENT_SECRET = DEAD
SENTRY_GCP_CLIENT_SECRET = DEAD
SENTRY_AWS_LAMBDA_SECRET_ACCESS_KEY = DEAD
SENTRY_MARKETO_CLIENT_SECRET = DEAD
SENTRY_EMAIL_ENABLE_REPLIES = DEAD
SENTRY_EMAIL_REPLY_HOSTNAME = DEAD
SENTRY_URL_PREFIX = DEAD
SENTRY_INTERNAL_URL_PREFIX = DEAD
SENTRY_FLYIO_CLIENT_ID = DEAD
SENTRY_FLYIO_CLIENT_SECRET = DEAD
SENTRY_GITHUB_APP_ID = DEAD
SENTRY_GITHUB_APP_NAME = DEAD
SENTRY_GITHUB_APP_CLIENT_ID = DEAD
SENTRY_GITHUB_CONSOLE_SDK_APP_ID = DEAD
SENTRY_GITHUB_CONSOLE_SDK_APP_CLIENT_ID = DEAD
SENTRY_SLACK_CLIENT_ID = DEAD
SENTRY_SLACK_STAGING_CLIENT_ID = DEAD
SENTRY_VSTS_CLIENT_ID = DEAD
SENTRY_VSTS_NEW_CLIENT_ID = DEAD
SENTRY_VSTS_LIMITED_CLIENT_ID = DEAD
SENTRY_VERCEL_CLIENT_ID = DEAD
SENTRY_MSTEAMS_CLIENT_ID = DEAD
SENTRY_MSTEAMS_APP_ID = DEAD
SENTRY_DISCORD_APPLICATION_ID = DEAD
SENTRY_DISCORD_PUBLIC_KEY = DEAD
SENTRY_GCP_CLIENT_ID = DEAD
SENTRY_AWS_LAMBDA_ACCESS_KEY_ID = DEAD
SENTRY_PAGERDUTY_APP_ID = DEAD
SENTRY_SYMBOL_SERVER_ENABLED = DEAD
SENTRY_SYMBOLICATOR_OPTIONS = DEAD
SENTRY_REPLAY_STORAGE_OPTIONS = DEAD
SENTRY_CHART_RENDERING_STORAGE_OPTIONS = DEAD
...
if ngrok_host:
    SENTRY_URL_PREFIX = f"https://{ngrok_host}"
